...
const ThemeProvider = ({ children }: ThemeProviderProps): JSX.Element => {
  ...
  const [themeContrastState, setThemeContrast] =
    useState<ThemeContrast>(defaultThemeContrast);

  const [isOpen, setIsOpen] = useState<boolean>(defaultPanelSwitch);
  ...
  /**
   * When the panel control is clicked, set the panel to be open or closed.
   */
